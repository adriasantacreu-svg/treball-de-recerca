...
1. **PROHIBICIÓ TOTAL DE .OLD:** L'agent té prohibit entrar, llegir o llistar el directori `.old`. És una REDLINE crítica. Tota l'activitat s'ha de centrar exclusivament en tots els fitxers que tinguin a veure amb el `treball-de-recerca`.
...
6. **MODE PLANIFICACIÓ PER CANVIS ESTRUCTURALS O DE CONTINGUTS IMPORTANTS:** Si els canvis impliquen modificar moltes estructures, elements o parts del document, hauràs d'activar el mode planificació, planificar els teus moviments i canvis en funció del que t'hagi demanat i de tot el que estigui implicat en aquest, i demanar la meva autorització un cop em presentis aquest pla.
...
4. **Compilació:** Abans de donar per finalitzada una tasca del document, compilaràs el codi en un PDF, i si mostra errors greus de compilació t'asseguraràs d'instalar dependències o buscar per internet la solució a aquests, PREVAL mantenir les estructures, fonts i elements per sobre d'ELIMINAR-LOS, és a dir: no intentis arreglar els errors eliminant elements, paquets o estructures, busca la manera de preservar-los.
